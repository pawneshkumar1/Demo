      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-muted leading-relaxed mb-10 text-base font-medium">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-xs font-extrabold uppercase tracking-[0.3em] text-ink mb-10">Contact</h4>
            <ul className="space-y-8">
              <li className="flex gap-5">
                ...
                <span className="text-sm text-slate-muted leading-relaxed font-medium">Sector 62, Noida, <br />Uttar Pradesh, India</span>
              </li>
              <li className="flex gap-5">
                <div className="w-10 h-10 rounded-xl bg-bg-light flex items-center justify-center text-primary shrink-0 border border-slate-100">
                  <Mail size={18} />
                </div>
                <span className="text-sm text-slate-muted font-medium">connect@batuk.in</span>
              </li>
            </ul>
          </div>
          ...
          {/* Explore */}
          <div>
            <h4 className="text-xs font-extrabold uppercase tracking-[0.3em] text-ink mb-10">Explore</h4>
            <ul className="space-y-5">
              {['Digital Gold', 'Digital Silver', 'Savings Plan (SIP)', 'Buy-Back Policy'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-slate-muted hover:text-primary transition-colors font-medium">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-xs font-extrabold uppercase tracking-[0.3em] text-ink mb-10">Resources</h4>
            <ul className="space-y-5">
        ...
        <div className="pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-3 text-slate-muted">
            ...
            <span className="text-[10px] font-extrabold uppercase tracking-[0.2em]">Bank-Grade SSL Encryption</span>
          </div>
        </div>
      </div>
    </footer>
